...
include { SEQKIT_STATS as SEQKIT_STATS_ULK       } from '../modules/local/raw_qc.nf'
include { SEQKIT_STATS as SEQKIT_STATS_POREC     } from '../modules/local/raw_qc.nf'
include { SEQKIT_STATS as SEQKIT_STATS_CORRECTED } from '../modules/local/raw_qc.nf'
